...
function showStudentData(e) {
  ...
  for (var j = 0;j < sa.length;j++) {
    if (sa[j]['active'] === true) {
      ...
      porcentajeHse = (((sumSprintTotalH / ss.length) / 1200) * 100).toFixed(2);
      nombre = "user";
    }
